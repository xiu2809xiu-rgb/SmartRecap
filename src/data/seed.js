...
export const SAMPLE_QUIZ = {
  questions: [
    ...
    },
    {
      ...
      topic: 'Keys',
      difficulty: 2,
      prompt: 'Which statements about primary keys are correct? Select every correct answer.',
      options: [
        'They uniquely identify each row',
        'They may be made from several columns',
        'They may contain NULL values',
        'They may repeat across rows',
      ],
      answer: [0, 1],
      explanation: 'A primary key uniquely identifies each row and may be a composite of several columns. It cannot be NULL or repeated.',
      citations: ['c4'],
      verified: true,
    },
    {
      ...
      topic: 'Denormalisation',
      difficulty: 2,
      prompt: 'Why might a team deliberately denormalise a database schema?',
      modelAnswer: 'A team may denormalise to reduce joins and improve read speed, while accepting extra write complexity, redundancy and integrity risk.',
      rubric: 'Mention reducing joins or improving read speed, and acknowledge the trade-off of redundancy, write complexity or integrity risk.',
      explanation: 'Denormalisation trades additional redundancy and write-side risk for faster reads that require fewer joins.',
      citations: ['c11'],
      verified: true,
    },
  ],
